# User password authentication with a Log'n Pass 2FA code
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/PHP-UserPassword-2FA-With-LogNPass).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/PHP-UserPassword-2FA-With-LogNPass) and [open a new issue](https://github.com/DeveloppeurPascal/PHP-UserPassword-2FA-With-LogNPass/issues).
